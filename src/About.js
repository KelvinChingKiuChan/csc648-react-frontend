...
function About() {
    return (
        <div id="About" style= {{background: "repeating-linear-gradient(black 0%, #663399 60vh, white 100%, white 100%)"}}>
...
//"repeating-linear-gradient(Indigo 0%, #663399 60vh, white 100%, white 100%)"
